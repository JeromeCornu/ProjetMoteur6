...
namespace GC_3D
{
    ...
    void ImguiTool::Window(int* NumberCubes, float* RotateX, float* RotateY, float* RotateZ, Camera* MainCamera, float* LightColorX, float* LightColorY, float* LightColorZ, float* LightPower, float* Speed)
    {
    ...
    bool ImguiTool::ColorPicker(const char* label, float col[3])
    {
